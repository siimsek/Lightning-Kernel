...
ZIPNAME="Surgex-ginkgay-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
...
export KBUILD_BUILD_USER="ginkgo"
...
elif ! git clone -q https://github.com/DeliUstaTR/AnyKernel3.git -b ginkgo; then
